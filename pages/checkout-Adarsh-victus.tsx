...
export default function Checkout() {
    ...
    const { amount = '299', currency = 'INR' } = router.query
        ...
        <Layout title="Checkout - VAYRO">
            ...
            <div className="flex justify-center items-center min-h-[60vh]">
                <Card className="w-full max-w-md p-8 text-center">
                    ...
                    <div className="text-4xl font-bold text-gold mb-8">{displaySymbol}{amount}<span className="text-lg text-slateGray font-normal">/month</span></div>
